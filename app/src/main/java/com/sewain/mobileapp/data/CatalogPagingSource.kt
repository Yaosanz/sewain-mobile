...
class StoryPagingSource(private val apiService: ApiService) : PagingSource<Int, CatalogItem>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CatalogItem> {
        return try {
            ...
            val responseData = apiService.getCatalogs(page, params.loadSize).results
